...
| `onboardingChecklist` | `map` | ✅ | Key-value mapping of non-background-check checkpoints, e.g., `{"trainingCompleted": false}`. `backgroundCheck` was removed from this map in P3-E27-B2 — see the dedicated `backgroundCheck` field below. |
